import { GoogleMap, HeatmapLayer, Control } from 'react-google-map-wrapper';
  ...
  return (
    <>
      ...
      <Control position={google.maps.ControlPosition.TOP_CENTER}>
        <div className='flex gap-2 pt-3' id='floating-panel'>
          <ControlButton id='toggle-heatmap' onClick={toggleHeatmap}>
            Toggle Heatmap
          </ControlButton>
          <ControlButton id='change-gradient' onClick={changeGradient}>
            Change gradient
          </ControlButton>
          <ControlButton id='change-radius' onClick={changeRadius}>
            Change radius
          </ControlButton>
          <ControlButton id='change-opacity' onClick={changeOpacity}>
            Change opacity
          </ControlButton>
        </div>
      </Control>
...
export function HeatmapLayerEx() {
  return (
    <Container>
      <GoogleMap
        className='h-[400px]'
