  ...
  const [OverlayMarker] = useState(
    () =>
      ...
      (classCache = class OverlayMarkerImpl extends google.maps.OverlayView implements OverlayMarker {
        ...
        mouseUpHandler;
        mouseLeaveHandler;
        eventMap = new Map<String, (position: google.maps.LatLngLiteral) => void>();
        ...
        private addeEvent() {
          ...
          const getCurrentCoordinate = (e: MouseEvent) => {
            ...
            return this.getProjection().fromDivPixelToLatLng(new google.maps.Point(pos.x - left, pos.y - top))!;
          };
            ...
            (this.mouseUpHandler = (e) => {
              if (isDown) {
                ...
                if (this.mouseMoveHandler) {
                  ...
                  this.eventMap.get('mouseup')?.(getCurrentCoordinate(e).toJSON());
                }
              }
            })
          );
        ...
        addDragEventListener(key: string, fn: (position: google.maps.LatLngLiteral) => void) {
